...
class ESC_POS_Page extends StatefulWidget {
  ESC_POS_Page({Key? key, required this.title}) : super(key: key);
  final String title;

  @override
  _ESC_POS_PageState createState() => _ESC_POS_PageState();
}

class _ESC_POS_PageState extends State<ESC_POS_Page> {
