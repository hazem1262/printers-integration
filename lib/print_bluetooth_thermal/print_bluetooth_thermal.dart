...
class PrintBluetoothThermalScreen extends StatefulWidget {
  const PrintBluetoothThermalScreen({Key? key}) : super(key: key);

  @override
  _PrintBluetoothThermalState createState() => _PrintBluetoothThermalState();
}

class _PrintBluetoothThermalState extends State<PrintBluetoothThermalScreen> {
  String _info = "";
  String _msj = '';
